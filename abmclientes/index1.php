            ...
            <div class="col-6">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <a href="index1.php" class="btn btn-danger my-2">NUEVO</a>
                    </div>
                </form>
            </div>
            <div class="col-6">
                <table class="table table-hover border">
                    ...
                    <?php foreach ($aClientes as $pos => $cliente) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="index1.php?pos=<?php echo $pos; ?>&do=editar"><i class="bi bi-pencil"></i></a>
                                <a href="index1.php?pos=<?php echo $pos; ?>&do=eliminar"><i class="bi bi-trash-fill"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>
