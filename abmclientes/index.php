...
if ($_POST) {
    ...
    $nombreImagen = "";
    if ($pos >= 0) {
        //actualiza la informacion cuando se está editando
        if ($_FILES["archivo"]["error"] === UPLOAD_ERR_OK) {
            ...
            //Marener el nombre de la imagen que tenía antes 
            $aClientes[$pos]['imagen'];
            ...
            <div class="col-4">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="text" name="txtEmail" id="txtEmail" class="form-control" required value="<?php echo  isset($aClientes[$pos]) ? $aClientes[$pos]["correo"] : ""; ?>">
                    </div>
                    <div>
                        ...
                        <tr>
                            <td>
                                <?php if ($cliente["imagen"] != "") : ?>
                                    ...
                                    <img src="imagenes/<?php echo $cliente['imagen'] ?>" alt="img-thumbnail" width="50" height="50">
                                    <!-- <img src="imagenes/2022081206085043.jpg" class="img-thumbnail"> -->
                                <?php endif; ?>
